...
struct Entry_
{
  ...
  typedef boost::shared_ptr< ::mlog_msgs::Entry_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::mlog_msgs::Entry_<ContainerAllocator> const> ConstPtr;

}; // struct Entry_

typedef ::mlog_msgs::Entry_<std::allocator<void> > Entry;

typedef boost::shared_ptr< ::mlog_msgs::Entry > EntryPtr;
typedef boost::shared_ptr< ::mlog_msgs::Entry const> EntryConstPtr;
